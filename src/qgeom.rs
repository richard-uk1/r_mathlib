...
#[no_mangle]
pub unsafe extern "C" fn qgeom(
    mut p: libc::c_double,
    mut prob: libc::c_double,
    mut lower_tail: libc::c_int,
    mut log_p: libc::c_int,
) -> libc::c_double {
    if p.is_nan() as i32 != 0 as libc::c_int || prob.is_nan() as i32 != 0 as libc::c_int {
        return p + prob;
    }
    if prob <= 0 as libc::c_int as libc::c_double || prob > 1 as libc::c_int as libc::c_double {
    ...
    if prob == 1 as libc::c_int as libc::c_double {
